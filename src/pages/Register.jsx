...
const Register = () => {
    ...
    const { createUser, googleUser, updateUser } = use(AuthContext)
            ...
            <div className="card bg-base-100 w-full max-w-sm mx-auto shrink-0 shadow-2xl">
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={handleRegister} className="fieldset">
                        ...
                        <p className='text-center text-[18px] mt-4'>Already have an account? <Link className='text-secondary ' to='/auth/login'>Login</Link></p>
                    </form>
